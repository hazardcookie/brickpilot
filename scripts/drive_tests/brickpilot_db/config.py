...
import os, tomllib
DEFAULT_CONFIG = Path("/Users/brick/.config/brickpilot/drive_db.toml")
DEFAULT_ARTIFACT_ROOT = Path("/Users/brick/BrickpilotDriveDB/artifacts")
DEFAULT_BACKUP_ROOT = Path("/Users/brick/BrickpilotDriveDB/backups")
