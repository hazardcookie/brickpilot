...
Set database_url in /Users/brick/.config/brickpilot/drive_db.toml, e.g.:
database_url = "postgresql://$DB_USER@localhost/$DB_NAME"
Then run: python3 -m scripts.drive_tests.brickpilot_db.migrate --config /Users/brick/.config/brickpilot/drive_db.toml
EOF
