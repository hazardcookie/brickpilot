...
DEFAULT_DATA_ROOT = Path(os.environ.get("BRICKPILOT_DRIVE_DATA_ROOT", "/Users/brick/BrickpilotDriveDB"))
...
INDEX_HTML = _replace_generated_asset_once(
    ...
    "let jobs=[],data=null,job=null,labels={drive:[],phev:[]},finished=[],editingReview=null,currentEditRef=null,bookmarkEdits={},showBookmarkOverlay=true,showToolEvents=false,showActivityBars=true,viewStart=0,viewEnd=null,routeCursor=0,lastVideoTime=0,dragZoom=null,dragTimeline=null,undoStack=[],suppressTimelineClick=false;",
)
