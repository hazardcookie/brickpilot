...
```bash
cd /Users/brick/comma-dev/sunnypilot-src
...
- Creates `/Users/brick/BrickpilotDriveDB/voice_bookmarks/<timestamp>_<name>/`.
...
python3 scripts/drive_tests/voice_bookmarker.py transcribe-template \
  /Users/brick/BrickpilotDriveDB/voice_bookmarks/20260513_210000_commute-test \
...
python3 scripts/drive_tests/voice_bookmarker.py import \
  /Users/brick/BrickpilotDriveDB/voice_bookmarks/20260513_210000_commute-test \
  --labeler-dir /Users/brick/BrickpilotDriveDB/labeler_outputs/manual_drive_labeler_<route_slug>
```
...
- Generated artifacts are intended to live under the already-local `analysis/drive_tests` tree.
