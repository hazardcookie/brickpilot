...
class CAR(Platforms):
  ...
  HYUNDAI_TUCSON_4TH_GEN = HyundaiCanFDPlatformConfig(
    ...
    # Local research override for Dan's 2022 Tucson PHEV. Door-jamb sticker: GVWR 5247 lb, payload 926 lb -> estimated curb 4321 lb / 1960 kg.
    CarSpecs(mass=1960, wheelbase=2.756, steerRatio=13.7, tireStiffnessFactor=0.385),
  )
