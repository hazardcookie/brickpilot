...
class CarController(CarControllerBase, EsccCarController, LeadDataCarController, LongitudinalController, MadsCarController,
  ...
  def update(self, CC, CC_SP, CS, now_nanos):
    ...
    apply_steer_req = self.get_tucson_canfd_apply_steer_req(CC, CS, apply_steer_req)

    canfd_actuation_inactive = bool(self.CP.flags & HyundaiFlags.CANFD and not apply_steer_req)
    if not CC.latActive or canfd_actuation_inactive:
      apply_torque = 0
