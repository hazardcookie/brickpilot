...
struct ControlsState @0x97ff69c53601abf1 {
  ...
  forceDecel @51 :Bool;
  brickpilotShadow @67 :BrickpilotShadowState;
  ...
  # Brickpilot R&D shadow-only telemetry. These values are for offline route
  # analysis and candidate labeling; they must not feed back into controls.
  struct BrickpilotShadowState {
    accelCmd @0 :Float32;           # controlsd requested accel command, m/s^2
    accelOutputCan @1 :Float32;     # last actuator accel reported by carcontroller, m/s^2
    lazyCandidate @2 :Bool;         # low-speed lead/standstill candidate for future stop-go study
    nearStandstill @3 :Bool;        # below near-standstill threshold or true standstill
    standstill @4 :Bool;
    cruiseStandstill @5 :Bool;
    hasLead @6 :Bool;
    leadStatus @7 :Bool;
    leadDistance @8 :Float32;       # leadOne distance, meters; 0 when unavailable
    aEgo @9 :Float32;
    speedDeficit @10 :Float32;      # planned near-term speed minus vEgo, m/s
    lateralError @11 :Float32;      # torque lateral accel error when available
    torqueCmd @12 :Float32;         # normalized torque command from controlsd
    torqueOutputCan @13 :Float32;   # last torque reported by carcontroller, CAN units
    outputPinned @14 :Bool;         # last output appears clipped/limited by safety
    outputTorqueRate @15 :Float32;  # normalized torque cmd rate, per second
    desiredLateralJerk @16 :Float32;
    steeringPressed @17 :Bool;
    longActive @18 :Bool;
    latActive @19 :Bool;
    stopping @20 :Bool;
