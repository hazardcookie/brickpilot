...
from openpilot.selfdrive.ui.feedback.bookmark_tags import append_bookmark_tag
...
class MainLayout(Widget):
  def __init__(self):
    ...
    self._layouts = {
      ...
      MainState.ONROAD: AugmentedRoadView(bookmark_tag_callback=self._on_bookmark_tag_selected),
    }
  ...
  def _on_bookmark_clicked(self) -> int:
    user_bookmark = messaging.new_message('bookmarkButton')
    user_bookmark.valid = True
    self._pm.send('bookmarkButton', user_bookmark)
    onroad_layout = self._layouts[MainState.ONROAD]
    if hasattr(onroad_layout, 'show_bookmark_tag_prompt'):
