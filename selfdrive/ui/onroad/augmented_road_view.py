...
class AugmentedRoadView(CameraView, AugmentedRoadViewSP):
  ...
  def _render(self, rect):
    ...
    self.alert_renderer.set_suppressed_event_names(suppressed_alerts)
  ...
  def show_bookmark_tag_prompt(self, bookmark_log_mono_time: int | None) -> None:
    self._bookmark_tag_prompt.show(bookmark_log_mono_time)

  def _handle_mouse_press(self, _):
    if self._bookmark_tag_prompt.interacting():
      return
